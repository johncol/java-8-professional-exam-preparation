...
interface AwesomeShippableA<T> extends Shippable<T> {}
interface AwesomeShippableB<T> extends Shippable {}
interface AwesomeShippableC extends Shippable<String> {}
interface AwesomeShippableD extends Shippable {}
